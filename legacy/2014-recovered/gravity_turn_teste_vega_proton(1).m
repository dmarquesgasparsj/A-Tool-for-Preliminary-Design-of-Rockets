...
md3 = (m_prop3)/tb3;
md4 = (m_prop4)/tb4;
T1   = 2261e3;%T_1;%md1*(Isp1*g0);    % [N] Thrust (mean) 2000000;% 5885000;
T2   = 1196e3;%T_2;%md2*(Isp2*g0);   %1500000;% 801000;%
T3   = 225e3;%T_3;%md3*(Isp3*g0);
T4   = 245e3;%T_4;%md4*(Isp4*g0);
