...
function [m0,tb1,tb2,tb3,T_1,T_2,T_3,V1perc,V2perc,V3perc,Mp1,Mp2,Mp3,M_1,M_2,M_3]=mass_model_n_3 (DeltaVestimation,Mpl,Isp1,Isp2,Isp3,OF1,OF2,OF3) % Eps = Epsilon = structural factor
clear all
clc
DeltaVestimation=9000;
Mpl=2300;
Isp1=280;
Isp2=289;
Isp3=294;
        ...
        if (1 - V1per(ii) - V2per(iii))>=0   % garantir que V3per nă é negatvo
            ...
            if V3per >= V3perc -0.11 && V3per <= V3perc +0.1
                ...
                for Eps3 = 0.05:0.01:0.17
                    ...
                    if Mglobal(iiii,7,iii)/Mglobal(iiii,8,iii) <= 1.1 && Mglobal(iiii,7,iii)/Mglobal(iiii,8,iii) > 0.9
                ...
                for Eps2 = 0.05:0.01:0.17
                    ...
                    if Mglobal(iiiii,5,iii)/Mglobal(iiiii,6,iii) <= 1.1 && Mglobal(iiiii,5,iii)/Mglobal(iiiii,6,iii) > 0.9
                ...
                for Eps1 = 0.05:0.01:0.17
                    ...
                    if Mglobal(iiiiii,3,iii)/Mglobal(iiiiii,4,iii) <= 1.1 && Mglobal(iiiiii,3,iii)/Mglobal(iiiiii,4,iii) > 0.9
