...
function [m0,tb1,tb2,tb3,tb4,T_1,T_2,T_3,T_4,V1perc,V2perc,V3perc,V4perc,Mp1,Mp2,Mp3,Mp4,M_1,M_2,M_3,M_4]=mass_model_n_4_it (DeltaVestimation,Mpl,Isp1,Isp2,Isp3,Isp4,OF1,OF2,OF3,OF4) % Eps = Epsilon = structural factor
% clear all
% clc
            ...
            if (1- V3per(iiii) -V2per(iii) - V1per(ii)) > 0
                ...
                if V4per >= V4perc -0.1 && V4per <= V4perc +0.1
                    ...
                    for Eps4 = 0.05:0.01:0.17
                        ...
                        if abs(Mglobal(iiiii,11,ii)-Mglobal(iiiii,10,ii))<=100
                    ...
                    for Eps3 = 0.05:0.01:0.17
                        ...
                        if abs(Mglobal(iiiiii,8,ii)-Mglobal(iiiiii,9,ii))<=100
                    ...
                    for Eps2= 0.05:0.01:0.17
                        ...
                        if abs(Mglobal(iiiiiii,7,ii)-Mglobal(iiiiiii,6,ii))<=100
                    ...
                    for Eps1 = 0.05:0.01:0.17
                        ...
                        if abs(Mglobal(iiiiiiii,4,ii)-Mglobal(iiiiiiii,5,ii))<=10
