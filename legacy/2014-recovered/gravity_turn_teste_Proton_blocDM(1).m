...
function []=gravity_turn(Isp1,Isp2,Isp3,Isp4,Mp1,Mp2,Mp3,Mp4,M_1,M_2,M_3,M_4,T_1,T_2,T_3,T_4)
...
% Vega specifications
N=4;
m_prop1=  419410;%Mp1 ;%108365;       % [kg] Propellant mass
m_prop2=  156113;%Mp2 ;%85000;
m_prop3=  46562;%Mp3 ;
m_prop4=  15200;%Mp4 
Isp1 = 285; % [s]  Specific impulse
Isp2 = 327;
Isp3 = 327;
Isp4 = 353;
g0     = 9.81;        % [m/s^2] Constant at its sea-level value
m01  = 686927;%M_1;         % [kg] Initial mass
m02  = 236927;%M_2;
m03  = 69097;%M_3;
m04  = 18350;%M_4;
d   = 3.7;           % [m]  Diameter
...
hgr_turn = 500;       % [m] Rocket starts the gravity turn when h = hgr_turn
tb1 = 120;%160.8;  % [s] Fuell burn time, first stage
tb2 = 210;%200;
tb3 = 230;
tb4 = 600;
tc1=1; 
...
md3 = (m_prop3)/tb3;
md4 = (m_prop4)/tb4;
T1   = 6*1470000;%T_1;%md1*(Isp1*g0);    % [N] Thrust (mean) 2000000;% 5885000;
T2   = 4*582000;%T_2;%md2*(Isp2*g0);   %1500000;% 801000;%
T3   = 582000;%T_3;%md3*(Isp3*g0);
T4   = 87000;%T_4;%md4*(Isp4*g0);
...
[t,state] = ode45(@RocketDynEq,t_range,state0,options) ;
