...
% Vega specifications
N=4;
m_prop1=  80000;%Mp1 ;%108365;       % [kg] Propellant mass
m_prop2=  24000;%Mp2 ;%85000;
m_prop3=  9500;%Mp3 ;
m_prop4=  370;%Mp4 
Isp1 = 280; % [s]  Specific impulse
Isp2 = 289;
Isp3 = 294;
Isp4 = 317;
g0     = 9.81;        % [m/s^2] Constant at its sea-level value
m01  = 124457;%M_1;         % [kg] Initial mass
m02  = 37119;%M_2;
m03  = 11219;%M_3;
m04  = 719;%M_4;
d   = 1.9;           % [m]  Diameter
...
tb1 = 106.8 ;%160.8;  % [s] Fuell burn time, first stage
tb2 = 71.7;%200;
tb3 = 109.6;
tb4 = 620;
tc1=1; 
...
md3 = (m_prop3)/tb3;
md4 = (m_prop4)/tb4;
T1   = 2440000;%T_1;%md1*(Isp1*g0);    % [N] Thrust (mean) 2000000;% 5885000;
T2   = 959000;%T_2;%md2*(Isp2*g0);   %1500000;% 801000;%
T3   = 230000;%T_3;%md3*(Isp3*g0);
T4   = 22000;%T_4;%md4*(Isp4*g0);
